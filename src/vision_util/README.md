...
- **2026-07-03** — Add `depth_reproject.py`, a shared resolution-agnostic Orbbec depth-reprojection helper (also used by `object_detection_new`'s `YOLOSegmentationNode`). Fix `door_detection.py` to use it — it carried an independent copy of the same hardcoded-720×1280 reprojection bug.
